System.config({
  ...
  map: {
    ...
    "jeroenvinke/router": "github:jeroenvinke/router@build-master",
    "jeroenvinke/templating-router": "github:jeroenvinke/templating-router@build-master",
    "jquery": "npm:jquery@2.2.4",
    "text": "github:systemjs/plugin-text@0.0.8",
    "github:jeroenvinke/router@build-master": {
    ...
    "github:jeroenvinke/templating-router@build-master": {
